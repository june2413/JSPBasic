...
<c:set var="url">jdbc:mariadb://bigdata.chrpnj0d47aq.ap-northeast-2.rds.amazonaws.com:3306/playground</c:set>
...
<c:set var="hdate" 
	value="${param.hdate1}-${pram.hdate2}-${param.hdate3}" />
<c:set var="phone" 
...
<body>
<p><c:if test="${cnt gt 0}">사원 등록 완료!</c:if></p>

<p><a href="employees2.jsp">등록 사원 조회</a></p>
</body>
</html>